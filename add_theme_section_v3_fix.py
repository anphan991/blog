              ...
              <div className="flex flex-wrap gap-8 md:gap-12 w-full justify-start items-center">
                {[
                  ...
                  >
                    ...
                    {/* Text Info */}
                    <h3 
                      className="font-mono text-xl text-white tracking-widest text-center transition-colors uppercase group-hover:text-white"
                      style={{ color: '#A9A9A2' }}
                    >
                      {theme.name}
                    </h3>
...
# Find <section id="sec-archive" and replace it
if 'id="sec-theme"' not in content:
    content = content.replace('<section id="sec-archive"', theme_section + '\n\n            <section id="sec-archive"')
