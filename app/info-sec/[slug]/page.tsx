...
export default async function InfoSecPostPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <main className="min-h-screen bg-[#050505] text-[#94A3B8] p-4 md:p-8 pt-24 font-mono selection:bg-[#22d3ee] selection:text-white relative">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <Link 
          href="/info-sec" 
          className="inline-flex items-center gap-2 text-xs font-bold text-[#22d3ee] hover:text-white mb-8 transition-colors border border-[#22d3ee]/30 bg-cyan-950/20 px-4 py-2 hover:bg-[#22d3ee] hover:border-[#22d3ee] shadow-[2px_2px_0px_#22d3ee] active:shadow-none active:translate-x-[2px] active:translate-y-[2px]"
        >
          <ChevronLeft size={16} /> 
          <span>./escape</span>
        </Link>
        ...
        <article className="bg-[#0a0a0a] border-2 border-slate-800 shadow-[10px_10px_0px_rgba(0,0,0,1)] ring-1 ring-[#22d3ee]/20 relative overflow-hidden">
          ...
          <div className="p-6 md:p-12">
            <header className="mb-12 border-b-2 border-dashed border-blue-900/50 pb-8">
              <div className="flex items-center gap-2 text-[#22d3ee] mb-4 bg-[#22d3ee]/10 w-fit px-3 py-1 text-xs font-bold uppercase border border-[#22d3ee]/20">
              ...
              <div className="flex flex-wrap items-center gap-4 text-xs font-bold font-mono">
                ...
                <span className="text-[#22d3ee]">{post.data.date}</span>
            ...
            <div 
              className="prose prose-invert prose-cyan prose-headings:font-[\'VT323\',_monospace] prose-headings:text-cyan-400 prose-headings:tracking-widest prose-a:text-cyan-400 hover:prose-a:text-cyan-300 prose-code:text-cyan-300 prose-p:font-[\'Share_Tech_Mono\',_monospace] max-w-none font-sans text-slate-300 leading-relaxed
                        ...
                        prose-a:text-[#22d3ee] prose-a:font-bold prose-a:underline prose-a:decoration-blue-900 hover:prose-a:decoration-[#22d3ee] hover:prose-a:text-white transition-colors
                        prose-strong:text-white
                        prose-blockquote:border-l-4 prose-blockquote:border-[#22d3ee] prose-blockquote:bg-cyan-950/20 prose-blockquote:py-1 prose-blockquote:px-4 prose-blockquote:not-italic
            ...
            <div className="mt-16 pt-8 border-t-2 border-slate-800 text-center">
              <span className="text-[#22d3ee] font-bold animate-pulse text-xl">Bye World!</span>
            </div>
          </div>
        </article>
      </div>
