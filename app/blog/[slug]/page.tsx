      ...
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <article className="space-y-8 bg-white/5 backdrop-blur-md border border-white/10 rounded-3xl p-8 md:p-12 shadow-2xl">
          <header className="space-y-4 border-b border-white/10 pb-8">
            <h1 className="text-4xl md:text-5xl font-black text-white leading-tight italic">
              {data.title}
            </h1>
          ...
          {/* Nội dung bài viết */}
          <div 
            className="prose prose-invert prose-blue max-w-none prose-headings:font-bold prose-h2:text-blue-400 prose-code:text-pink-400 prose-code:bg-slate-800/50 prose-code:px-1.5 prose-code:rounded-md"
