...
import { Cookie, Bug, Zap, Mail, Github, Twitter, Gamepad2, FileText, Cpu, FolderTree, Radar, Network , Power } from 'lucide-react';
  ...
  return (
    <>
      ...
      <AnimatePresence>
        ...
        <NetworkParticles />
        <div className="absolute inset-0 z-0 pointer-events-none" style={{ background: 'repeating-linear-gradient(0deg, transparent, transparent 2px, rgba(34,211,238,0.20) 4px, rgba(34,211,238,0.2) 8px)' }}></div>        
...
<div className="desktop-windows absolute inset-0 z-10 pointer-events-none ">
      ...
      <div className="absolute bottom-8 right-8 md:bottom-40 md:right-12 z-50 pointer-events-auto">
        <button 
      ...
      <AnimatePresence>
        {showThemeMenu && (
          <motion.div 
            ...
            className="fixed inset-0 z-[99999] bg-black flex flex-col items-center justify-center pointer-events-auto overflow-hidden"
          >
            ...
            <button 
              ...
              className="absolute top-8 right-12 z-20 text-cyan-500 font-['Share_Tech_Mono',_monospace] text-sm md:text-base hover:text-white transition-colors uppercase tracking-widest bg-transparent border-none cursor-pointer"
            >
              [ ABORT_SEQUENCE ]
            </button>
            ...
            <div className="flex flex-wrap justify-center gap-6 md:gap-10 px-4 max-w-6xl z-20 relative">
              {[
                ...
                <motion.a
                  key={theme.id}
                  href={theme.link}
                  initial={{ opacity: 0, y: 50, rotateY: 30, borderColor: "#27272a", boxShadow: "0 0 0px rgba(0,0,0,0)" }}
                  animate={{ opacity: 1, y: 0, rotateY: 0, borderColor: "#27272a", boxShadow: "0 0 0px rgba(0,0,0,0)" }}
                  ...
                  className="relative group bg-[#0a0a0a] border-2 border-zinc-800 rounded-2xl p-6 w-48 md:w-56 flex flex-col items-center transition-all duration-15 no-underline cursor-pointer"
                  style={{
                    transformStyle: 'preserve-3d',
                    perspective: '1000px'
                  }}
